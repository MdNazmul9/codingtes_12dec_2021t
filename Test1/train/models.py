...
class Ticket(models.Model):
    ...
    to_station = models.ForeignKey(Station,on_delete=models.CASCADE,  related_name='end_station')
    from_station = models.ForeignKey(Station,on_delete=models.CASCADE,  related_name='start_station')
...
class TicketPurchase(models.Model):
    ...
    ticket = models.ForeignKey(Ticket,on_delete=models.CASCADE, related_name="purchase_tikets" )
